...
public class MybatisGen {
    ...
    public static void main(String[] args) {
        String path = System.getProperty("user.dir").concat(File.separator)
                ...
                .concat("com").concat(File.separator)
                .concat("shop_online").concat(File.separator);
        ...
        FastAutoGenerator.create("jdbc:mysql://127.0.0.1:3306/shop-online", "root", "root")
